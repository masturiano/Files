...
class neverValObj extends commonObj {
	...
	function neverValDidNotPasXls($dteFrom,$dteTo,$company,$source) {
		...
		from openquery(ORAPROD,'
				...
				And A.Invoice_Id not In (Select D.Invoice_Id From Ap_Invoice_Distributions_All D Where D.Org_Id in ($orgId) and D.match_status_flag = ''A'') 
