    ...
    case 'dispAgingPerVendor':
        ...
        ?>
            ...
            <table border="0" align="center" width="90%">  
                <tr>
                    <td align="right">
                        <input type="button" name="viewAgingCheckDetails" class="btn btn-success" onClick="agingPerVendorCheckDetails();" value="Check Details">
                    </td>
                </tr>
            </table>
        ...
        ?>
            ...
            <table id="agingCheckDetails" class="agingCheckDetails" align="center" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left"><? if($val['pos_cur'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['pos_cur'],2); ?></font></td>
                        <td align="left"><? if($val['neg_cur'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['neg_cur'],2); ?></font></td>
                        <td align="left"><? if($val['pos_over30'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['pos_over30'],2); ?></font></td>
                         <td align="left"><? if($val['neg_over30'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['neg_over30'],2); ?></font></td> 
                        <td align="left"><? if($val['pos_over60'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['pos_over60'],2); ?></font></td>
                        <td align="left"><? if($val['neg_over60'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['neg_over60'],2); ?></font></td>    
                        <td align="left"><? if($val['pos_over90'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['pos_over90'],2); ?></font></td>
                        <td align="left"><? if($val['neg_over90'] < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($val['neg_over90'],2); ?></font></td>
                    </tr>
                    <?php 
            ...
            <tfoot>
                    <tr>
                        ...
                        <td align="left"><? if($tot_neg_cur < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_neg_cur,2); ?></font></td>
                        <td align="left"><? if($tot_pos_over30 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_pos_over30,2); ?></font></td>
                        <td align="left"><? if($tot_neg_over30 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_neg_over30,2); ?></font></td> 
                        <td align="left"><? if($tot_pos_over60 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_pos_over60,2); ?></font></td>
                        <td align="left"><? if($tot_neg_over60 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_neg_over60,2); ?></font></td>    
                        <td align="left"><? if($tot_pos_over90 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_pos_over90,2); ?></font></td>
                        <td align="left"><? if($tot_neg_over90 < 0){ ?><font style="color: red;"><?php } ?><? echo number_format($tot_neg_over90,2); ?></font></td>
                    </tr> 
                </tfoot>
