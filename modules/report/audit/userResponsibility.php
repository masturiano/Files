...
switch($_GET['action']){
	...
	case "GETAUTO":
			$arrResult = array();
				$arr= $userResponsibilityObj($_GET['term']);
				foreach($arr as $val){
					$arrResult[] = array(
						"id"=>$val['cusnum'],
	...
	case 'valCustomerNum':
		$cusNum = $userResponsibilityObj->checkCustomerNumber($_GET['customerNumber']);
			if($cusNum > 0){
				echo "1";
			}else{
				echo "0";
	...
	case 'Print':
			echo "window.open('userResponsibility_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> User Responsibility </font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
						<tr>
							...
							<td><font style="font-size:13px"> Date From </font></td>
							...
							<td><font style="font-size:13px"> Date To </font></td>
							<td><font style="font-size:13px"> : </font></td>
                        ...
                        <tr>
                            <td><font style="font-size:13px"> Form Name </font></td>
                            <td><font style="font-size:13px"> : </font></td>
                            <td colspan = "4"><? $userResponsibilityObj->DropDownMenu($userResponsibilityObj->makeArr($userResponsibilityObj->findFormName(),'USER_FORM_NAME','USER_FORM_NAME',''),'formName','','class="selectBox2 ui-widget-content ui-corner-all"'); ?></td>
                        </tr>
                        <tr>
                            <td colspan = "6"> </td>
                        </tr>
