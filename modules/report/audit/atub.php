...
switch($_GET['action']){
	...
	case 'Print':
			echo "window.open('atub_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
...
$arrOrgId = array('85'=>"PPCI",'87'=>"JR",'133'=>"PUREGOLD SUBIC");
//$arrOrgId = array('0'=>"All",'85'=>"PPCI",'87'=>"JR",'133'=>"PUREGOLD SUBIC");
//$arrOrgId = array('0'=>"All",'101'=>"PPCI",'700'=>"JR",'302'=>"PUREGOLD SUBIC");
?>
		...
		$(function() {
			$( "#tags" ).autocomplete({
				source: function(request, response) {
					$.getJSON('atub.php?action=GETAUTO', {
						term: request.term
					}, response);
				},
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> ATUB Posted Report</font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
						<tr>
							...
							<td><font style="font-size:13px"> Posted Date From </font></td>
							...
							<td><font style="font-size:13px"> Posted Date To </font></td>
							<td><font style="font-size:13px"> : </font></td>
						...
						<tr>
                            ...
                            <td><font style="font-size:13px"> : </font></td>
                            <td colspan = "4"><? $leasingSetupObj->DropDownMenu($leasingSetupObj->makeArr($leasingSetupObj->viewCustomer(),'cusnum','dispCusName',''),'dispCusName','','class="selectBox2 ui-widget-content ui-corner-all"'); ?></td>
                        </tr>
                        <tr>
                            <td colspan = "6"> </td>
                        </tr>
