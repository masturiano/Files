...
switch($_GET['action']){
	...
	case 'Print':
		...
		echo "window.open('invoiceStatus_xls.php?{$_SERVER['QUERY_STRING']}');";	
		...
		$(function() {
			$( "#tags" ).autocomplete({
				source: function(request, response) {
					$.getJSON('invoiceStatus.php?action=GETAUTO', {
						term: request.term
					}, response);
				},
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Invoice Status </font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
