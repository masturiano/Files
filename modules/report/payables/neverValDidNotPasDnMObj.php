...
class neverValDidNotPasDnMObj extends commonObj {
	...
	function neverValDidNotPasDnMXls($dteFrom,$company) {
		...
		select	ORAPROD.Org_id,ORAPROD.Segment1,ORAPROD.Invoice_Num,ORAPROD.Source,ORAPROD.Invoice_Date,
				ORAPROD.Creation_Date,ORAPROD.Invoice_Amount,ORAPROD.Batch_Name,ORAPROD.Attribute13,ORAPROD.Invoice_type_lookup_code,ORAPROD.Vendor_Site_Code
		from openquery(ORAPROD,'
				...
				And A.Source = ''Manual Invoice Entry''
