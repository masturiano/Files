...
switch($_GET['action']){
    ...
    case 'dispAging':
        ...
        $assAgingPositive = $vendorPerformanceObj->agingPositive();
        $assAgingNegative = $vendorPerformanceObj->agingNegative();
        $assAgingTotal = $vendorPerformanceObj->agingTotal();
        ...
        ?>
            ...
            <table border=1 align="center" width="90%">
                <tr>
                    <?php
                        foreach($assAgingHeader as $valHeader){
                            ?>
                            <td align="center" width="25%" bgcolor="lightgreen"><font style="font-size: 12;"><b> <?php echo $valHeader['bucket_name']; ?> </b></font></td>
                            <?php    
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        foreach($assAgingPositive as $valPositive){
                            ?>
                            <td align="center" width="25%">
                            <?php if($valPositive['amount_remaining'] < 0){ ?><font style="font-size: 12; color: red;"><?php }else{ ?><font style="font-size: 12;"><?php } ?>
                            <b> <?php echo number_format($valPositive['amount_remaining'],2); ?> </b></font></td>
                            <?php    
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        foreach($assAgingNegative as $valNegative){
                            ?>
                            <td align="center" width="25%">
                            <?php if($valNegative['amount_remaining'] < 0){ ?><font style="font-size: 12; color: red;"><?php }else{ ?><font style="font-size: 12;"><?php } ?>
                            <b> <?php echo number_format($valNegative['amount_remaining'],2); ?> </b></font></td>
                            <?php    
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        foreach($assAgingTotal as $valTotal){
                            ?>
                            <td align="center" width="25%">
                            <?php if($valTotal['amount_remaining'] < 0){ ?><font style="font-size: 12; color: red;"><?php }else{ ?><font style="font-size: 12;"><?php } ?>
                            <b>TOTAL: <?php echo number_format($valTotal['amount_remaining'],2); ?> </b></font></td>
                            <?php    
                        }
                    ?>
                </tr>
                ...
                <tr>
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){
                            ?>
                            <td align="center" width="25%" bgcolor="lightgreen"><font style="font-size: 12;"><b> <?php echo $valHeaderPerVendor['bucket_name']; ?> </b></font></td>
                            <?php    
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){  
                            ...
                            <b> <?php echo number_format($assAgingPositivePerVendor['amount_remaining'],2); ?> </b></font></td>
                            <?php 
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){
                            ...
                            <b> <?php echo number_format($assAgingNegativePerVendor['amount_remaining'],2); ?> </b></font></td>
                            <?php 
                        }
                    ?>
                </tr>
