...
switch($_GET['action']){
	...
	case 'Print':
			echo "window.open('perksTnap_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
...
$arrCardType = array('0'=>"Select card type",'Perks'=>"Perks",'Tnap'=>"Tnap");
?>
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Perks & Tnap Un Authorized </font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
                        <tr>
                            <td><font style="font-size:13px"> Card type </font></td>
                            <td><font style="font-size:13px"> : </font></td>
                            <td><? $perksTnapObj->DropDownMenu($arrCardType,'cmbCardTyp','','class="selectBox ui-widget-content ui-corner-all"'); ?></td>
                        </tr>
                        <tr>
                            <td colspan = "6"> </td>
                        </tr>
						<tr>
							<td><font style="font-size:13px"> Original Date</font></td>
							<td><font style="font-size:13px"> : </font></td>
							<td><input type="text" name="txtDateFrom" id="txtDateFrom" readonly="readonly" class="textBox" style="height:30px;"
                                placeholder="From"/></td>
						
							<td><font style="font-size:13px"> &nbsp - &nbsp </font></td>
							<td><input type="text" name="txtDateTo" id="txtDateTo" readonly="readonly" class="textBox" style="height:30px;"
                                placeholder="To"/></td>
						</tr>
						<tr>
							<td colspan = "6"> </td>
