...
class neverValDidNotPasObj extends commonObj {
	...
	function neverValDidNotPasXls($dteFrom,$company) {
		...
		select	ORAPROD.Org_id,ORAPROD.Segment1,ORAPROD.Invoice_Num,ORAPROD.Source,ORAPROD.Invoice_Date,
				ORAPROD.Creation_Date,ORAPROD.Invoice_Amount,ORAPROD.Batch_Name,ORAPROD.Attribute13
		from openquery(ORAPROD,'
				...
				And A.Source Not In (''RFP'',''Manual Invoice Entry'',''PAY'')
