...
$worksheet->write(2, 2, 'Location',$headerFormat1);
$worksheet->write(2, 3, 'Department',$headerFormat1);
$worksheet->write(2, 4, 'Start Date',$headerFormat1);
$worksheet->write(2, 5, 'End Date',$headerFormat1);
$worksheet->write(2, 6, 'Last Login',$headerFormat1);
$worksheet->write(2, 7, 'Responsibility',$headerFormat1);
$worksheet->write(2, 8, 'Description',$headerFormat1);
...
$orauserqry = "SELECT fnd_user.USER_ID, fnd_user.USER_NAME, fnd_user.START_DATE, fnd_user.END_DATE, fnd_user.DESCRIPTION, fnd_user_resp_groups_all.RESPONSIBILITY_ID, fnd_responsibility.RESPONSIBILITY_KEY, fnd_responsibility.START_DATE, fnd_responsibility.END_DATE,fnd_user.LAST_LOGON_DATE,fnd_user.EMAIL_ADDRESS,fnd_user.FAX
...
GROUP BY fnd_user.USER_ID, fnd_user.USER_NAME, fnd_user.START_DATE, fnd_user.END_DATE, fnd_user.DESCRIPTION, fnd_user_resp_groups_all.RESPONSIBILITY_ID, fnd_responsibility.RESPONSIBILITY_KEY, fnd_responsibility.START_DATE, fnd_responsibility.END_DATE,fnd_user.LAST_LOGON_DATE,fnd_user.EMAIL_ADDRESS,fnd_user.FAX
...
foreach($rs as $val)
{
	...
	{*/
		...
		$worksheet->write($ctr, 2, $rs->fields['EMAIL_ADDRESS'],$headerFormat1);
		$worksheet->write($ctr, 3, $rs->fields['FAX'],$headerFormat1);
	/*}*/
		$worksheet->write($ctr, 4, $rs->fields['START_DATE'],$headerFormat1);
		$worksheet->write($ctr, 5, $rs->fields['END_DATE'],$headerFormat1);
		$worksheet->write($ctr, 6, $rs->fields['LAST_LOGON_DATE'],$headerFormat1);
		$worksheet->write($ctr, 7, $rs->fields['RESPONSIBILITY_KEY'],$headerFormat1);
		$worksheet->write($ctr, 8, $rs->fields['DESCRIPTION'],$headerFormat1);
