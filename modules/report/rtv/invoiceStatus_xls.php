...
################### INCLUDE FILE #################
	...
	$filename = "Invoice_Status.xls";
	$workbook->send($filename);
	$worksheet = &$workbook->addWorksheet("Invoice Status");
	$worksheet->setLandscape();
	$worksheet->freezePanes(array(3,0));
	
	$worksheet->write(0,0,"Invoice Status From ".date('m/d/Y',strtotime($_GET['txtDateFrom']))." to Present",$headerFormat);
    ...
    $worksheet->write(2,13,"STORE NAME",$headerFormat);
		...
		$arrDailyPaidProc = $invoiceStatusObj->neverValDidNotPasXls($_GET['txtDateFrom'],$_GET['cmbOrgId'],$_GET['cmbSource'],$_GET['cmbStat'],$_GET['cmbValid']);
