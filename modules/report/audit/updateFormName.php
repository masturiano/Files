...
include("updateFormNameObj.php");

$updateFormNameObj = new updateFormNameObj();

switch($_POST['action']){
	
	case "update":
		
		if($updateFormNameObj->cleartblFormName()){
			$updateFormNameObj->updatetblFormName();
		}
            ...
            <form class="form-horizontal">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="2">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Update Form Name </font></h4>
                        </th>
                        <tr>
                        	<td colspan="3" align="center">
                            	<input type="button" name="submit" class="btn btn-success" onClick="updateFormName();" value="UPDATE">
                            </td>
                        </tr>
                     </table>
                </div>
