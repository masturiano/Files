...
switch($_GET['action']){
	...
	case 'valCustomerNum':
		$cusNum = $leasingSetupObj->checkCustomerNumber($_GET['customerNumber']);
			if($cusNum > 0){
				echo "1";
			}else{
				echo "0";
	...
	case 'Print':
			echo "window.open('concess_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
...
$arrOrgId = array('0'=>"All",'101,102,103,104,105,801,802,803,804,805,806,807,808'=>"PPCI",'700'=>"JR",'302'=>"PUREGOLD SUBIC",'810'=>"Daily Commodities Inc",'811'=>"First Lane Supertraders Co.Inc");
?>
		...
		$(function() {
			$( "#tags" ).autocomplete({
				source: function(request, response) {
					$.getJSON('concess.php?action=GETAUTO', {
						term: request.term
					}, response);
				},
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Concess Posted Report</font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
						<tr>
							...
							<td><font style="font-size:13px"> Vouche Date From </font></td>
							...
							<td><font style="font-size:13px"> Vouche Date To </font></td>
							<td><font style="font-size:13px"> : </font></td>
							<td><input type="text" name="txtDateTo" id="txtDateTo" readonly="readonly" class="textBox" style="height:30px;"/></td>
						</tr>
						<tr>
                            <td><font style="font-size:13px"> Supplier </font></td>
                            <td><font style="font-size:13px"> : </font></td>
                            <td colspan = "4"><? $leasingSetupObj->DropDownMenu($leasingSetupObj->makeArr($leasingSetupObj->viewSupplier(),'suppCode','suppCodeName',''),'supplierCode','','class="selectBox2 ui-widget-content ui-corner-all"'); ?></td>
                        </tr>
                        <tr>
                            <td colspan = "6"> </td>
                        </tr>
						...
						<tr>
							<td><font style="font-size:13px"> Site </font></td>
							<td><font style="font-size:13px"> : </font></td>
							<td colspan = "4"><? $leasingSetupObj->DropDownMenu($leasingSetupObj->makeArr($leasingSetupObj->findSite(),'strnum','strShrtName',''),'storeNum','','class="selectBox2 ui-widget-content ui-corner-all"'); ?></td>
						</tr>
						<tr>
							<td colspan = "6"> </td>
						</tr>
