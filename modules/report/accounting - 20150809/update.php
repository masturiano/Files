                	...
                	<table border=0 align="center" width="90%">  
                     ...
                     <table border=1 align="center" width="90%">  
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <input type="button" name="submit" class="btn btn-success" onClick="update();" value="UPDATE">
                            </td>
                        </tr>
                        <tr>
                            <td align="left" width="40%"><font style="font-size: 12;"> Ar Transaction, Ar Payment</font></td>
                            <td align="center">
                                <input type="button" name="submit" class="btn btn-success" onClick="updateAr();" value="UPDATE">
                            </td>
                        </tr>
                     </table>
                </div>
