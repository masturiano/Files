...
switch($_GET['action']){
	...
	case 'Print':
			echo "window.open('sts_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
...
$arrOrgId = array('0'=>"SELECT COMPANY",'85'=>"PPCI",'87'=>"JR",'133'=>"PUREGOLD SUBIC",'153'=>"DAILY COMMODITIES INC",'113'=>"FIRST LANE SUPERTRADERS CO INC");
		...
		$(function() {
			$( "#tags" ).autocomplete({
				source: function(request, response) {
					$.getJSON('sts.php?action=GETAUTO', {
						term: request.term
					}, response);
				},
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> AP STS vs Oracle</font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
						...
						<tr>
							...
							<td><font style="font-size:13px"> Upload Date From </font></td>
							<td><font style="font-size:13px"> : </font></td>
							<td><input type="text" name="txtDateFrom" id="txtDateFrom" readonly="readonly" class="textBox" style="height:30px;"/></td>
						
							<td><font style="font-size:13px"> Upload Date To </font></td>
							<td><font style="font-size:13px"> : </font></td>
