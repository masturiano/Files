...
switch($_GET['action']){
    ...
    case 'searchSupplier':
        $arrResult = array();
            $arrSupp = $customerPerformanceObj->findSupplier($_GET['term']);
    ...
    case 'dispPerVendor':
        $assPaidPosVendor = $customerPerformanceObj->getPaidPositivePerVendor($_GET['hdnSuppCode']);
        $assPaidNegVendor = $customerPerformanceObj->getPaidNegativePerVendor($_GET['hdnSuppCode']);

        $assPaidPosOutStaVendor = $customerPerformanceObj->getOutstandingPositivePerVendor($_GET['hdnSuppCode']);
        $assPaidNegOutStaVendor = $customerPerformanceObj->getOutstandingNegativePerVendor($_GET['hdnSuppCode']);
        
        $assPaidPosOutStaDueVendor = $customerPerformanceObj->getOutstandingDuePositivePerVendor($_GET['hdnSuppCode']);
        $assPaidNegOutStaDueVendor = $customerPerformanceObj->getOutstandingDueNegativePerVendor($_GET['hdnSuppCode']);
        ?>
    ...
    case 'dispAgingPerVendor':
        $assAgingHeaderPerVendor = $customerPerformanceObj->agingHeaderPerVendor($_GET['hdnSuppCode']);
        ...
        ?>
            ...
            <table border=1 align="center" width="90%">
                ...
                <tr>
                    ...
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){  
                            $assAgingPositivePerVendor = $customerPerformanceObj->agingPositivePerVendor($_GET['hdnSuppCode'],$valHeaderPerVendor['bucket_name']);
                            ?>
                            <td align="right" width="20%">
                ...
                <tr>
                    ...
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){
                            $assAgingNegativePerVendor = $customerPerformanceObj->agingNegativePerVendor($_GET['hdnSuppCode'],$valHeaderPerVendor['bucket_name']);
                            ?>
                            <td align="right" width="20%">
                ...
                <tr>
                    ...
                    <?php
                        foreach($assAgingHeaderPerVendor as $valHeaderPerVendor){
                            $assAgingTotalPerVendor = $customerPerformanceObj->agingTotalPerVendor($_GET['hdnSuppCode'],$valHeaderPerVendor['bucket_name']);
                            ?>
                            <td align="right" width="20%">
    ...
    case 'dispAgingPerVendorCheckDetails':
        $agingCheckDetails = $customerPerformanceObj->agingHeaderPerVendorCheckDetails($_GET['hdnSuppCode']);
        $storedProc =  $customerPerformanceObj->storedProc($_GET['hdnSuppCode']);
        ?>
            <br />
		...
		$(function() {
         ...
         $(function(){
            $("#txtSupp").autocomplete({
                source: "customerPerformance.php?action=searchSupplier",
                minLength: 1,
                select: function(event, ui) {    
