...
class needsRevalObj extends commonObj {
	...
	function neverValDidNotPasXls($dteFrom,$company) {
		...
		$sql="	
		select	ORAPROD.Org_id,ORAPROD.Segment1,ORAPROD.Invoice_Num,ORAPROD.Source,
		...
		from openquery(ORAPROD,'
				...
				And A.Invoice_Id In (Select B.Invoice_Id From Ap_Invoice_Distributions_All B Where B.Org_Id in ($orgId) And B.Match_Status_Flag != ''A'')
