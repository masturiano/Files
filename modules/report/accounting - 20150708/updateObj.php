...
class updateObj extends commonObj {
    ...
    function updatetblVenPerOutstanding(){
        ...
        */
        ...
        # Detail
        $sql = " 
        insert into ORS_tblVenPerOutstanding (org_id,vendor_id,segment1,amount_paid,invoice_amount,amount_remaining,terms_date)
        select    ORAPROD.org_id,ORAPROD.vendor_id,ORAPROD.segment1,ORAPROD.amount_paid,ORAPROD.invoice_amount,ORAPROD.amount_remaining,ORAPROD.terms_date
        from 
        openquery(ORAPROD,'
        SELECT 
        ap_invoices_all.org_id,  
    ...
    function updatetblVenPerOutstandingDue(){
        ...
        */
        ...
        # Detail
        $sql = " 
        insert into ORS_tblVenPerOutstandingDue (org_id,vendor_id,segment1,amount_paid,invoice_amount,amount_remaining,terms_date)
        select    ORAPROD.org_id,ORAPROD.vendor_id,ORAPROD.segment1,ORAPROD.amount_paid,ORAPROD.invoice_amount,ORAPROD.amount_remaining,ORAPROD.terms_date
        from 
        openquery(ORAPROD,'
        SELECT 
