...
include("neverValObj.php");

$neverValObj = new neverValObj();

//$userName = $_SESSION['userName'];
//$passWord = $_SESSION['passWord'];
//$userAcess = $neverValObj->login($userName,$passWord);
//$userNotExist = $neverValObj->getRecCount($neverValObj->loginNotExist($userName,$passWord));
...
switch($_GET['action']){
	...
	case 'Print':
		...
		echo "window.open('neverVal_xls.php?{$_SERVER['QUERY_STRING']}');";	
		//$neverValObj->dailyPaidProcessCsv($GET['txtDateFrom'],$GET['txtDateTo'],$GET['cmbOrgId']);
...
$arrOrgId = array('0'=>"All",'85'=>"PPCI",'87'=>"JR",'133'=>"PUREGOLD SUBIC",'89'=>"Dutyfree Clark",'91'=>"Dutyfree Subic",'113'=>"Daily Commodities Inc",'153'=>"First Lane Supertraders Co., Inc.");
$arrSource = array(
'0'=>"All",
'PO'=>"PO",
'STS'=>"STS",
...
<html>
	<head>
		...
		function printCsv(){
            ...
            var source = $('#cmbSource').val();
            
            
            if (valDateStartEnd(dateStart,dateEnd,'txtDateFrom','txtDateTo')){
                printDailyPaid(dateStart,dateEnd,orgId,source);
            }    
		}
		
		function printDailyPaid(dateStart,orgId,source) {
		...
		$(function() {
			$( "#tags" ).autocomplete({
				source: function(request, response) {
					$.getJSON('neverVal.php?action=GETAUTO', {
						term: request.term
					}, response);
				},
            ...
            <form name="formInq" id="formInq">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="6">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Never Validated </font></h4>
                        </th>
						<tr>
							<td colspan = "6"> </td>
						</tr>
						...
						<tr>
							...
							<td><font style="font-size:13px"> : </font></td>
							<td><? $neverValObj->DropDownMenu($arrOrgId,'cmbOrgId','','class="selectBox ui-widget-content ui-corner-all"'); ?></td>
						</tr>
                        <tr>
                            <td><font style="font-size:13px"> Source </font></td>
                            <td><font style="font-size:13px"> : </font></td>
                            <td><? $neverValObj->DropDownMenu($arrSource,'cmbSource','','class="selectBox ui-widget-content ui-corner-all"'); ?></td>
                        </tr>
						<tr>
							<td colspan = "6"> </td>
						</tr>
