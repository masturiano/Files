...
class manpowerBilObj extends commonObj {
    ...
    function manpowerBillingCsv() {
        ...
        */
        ...
        $sql6="
        EXECUTE master.dbo.xp_cmdshell  'bcp \"SELECT * from dbOracle..ORS_TblManpowerView where result is not null \"  queryout $fileDesti$filename -t -c  -Uoracle -Poracle@2015 -SWIN-PGCHEQUE'
        ";
