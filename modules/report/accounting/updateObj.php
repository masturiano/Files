...
class updateObj extends commonObj {
    ...
    function updateBucketNumFieldTblVenPerOutstandingDueWrongTermsDate(){
        // original terms date
        $sql = "
            UPDATE 
                ORS_tblVenPerOutstandingDue 
                set terms_date = '2015-02-10'
            where 
                invoice_num = '122' and segment1 = '14693'
        ";
        return $this->execQry($sql);
    }
    ...
    function updatetblArPayment(){
        ...
        openquery(ORAPROD,'
            ...
            WHERE ar_payment_schedules_all.ORG_ID              in (87,85,133)
    ...
    function updatetblArTransactionDueWrongTransactionDate(){
        $sql = "
        update ORS_tblArTransactionDue set trx_date = '2014-09-29' 
        where 
            trx_number like 'CMSI13534755%'
        ";
        return $this->execQry($sql);
    }
