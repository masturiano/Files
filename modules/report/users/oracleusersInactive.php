...
AND fnd_user.END_DATE IS NOT NULL
...
?>		
	...
	<a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/ORS/modules/report/users/oracleusersInactive_excel.php" target="_blank" >Download Excel</a>
