...
class manpowerBilObj extends commonObj {
    ...
    function manpowerBillingCsv() {
        ...
        $sql2="
        insert into ORS_tblManpower values('INVOICE_ID','SEGMENT1','VENDOR_NAME','_ORG_ID','VENDOR_SITE_CODE','INVOICE_NUM','INVOICE_DATE','INVOICE_AMOUNT','AMOUNT_REMAINING','SOURCE','DESCRIPTION','MATCH_STATUS_FLAG','CREATION_DATE','BANK_ACCOUNT_NAME','CHECK_NUMBER','CHECK_SIGNED_DATE','CHECK_RELEASED_DATE')
        ";
