                ...
                <div class="dvContainer">
                	<table border=0 align="center">
						...
						<tr>
							...
							<td><font style="font-size:13px"> : </font></td>
							<td colspan = "4"><input type="text" name="tags" id="tags" class="textBox" style="height:30px; width:495px;" onclick="makeBlank();"/></td>
						...
						<tr>
							...
							<td><font style="font-size:13px"> : </font></td>
							<td colspan = "4"><? $leasingSetupObj->DropDownMenu($leasingSetupObj->makeArr($leasingSetupObj->findSite(),'stshrt','strShrtName',''),'storeShort','','class="selectBox2 ui-widget-content ui-corner-all"'); ?></td>
						</tr>
						<tr>
							<td colspan = "6"> </td>
						</tr>
